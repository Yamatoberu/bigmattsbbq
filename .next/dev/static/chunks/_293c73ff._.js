...
"[project]/components/hooks/useActiveDrop.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useActiveDrop(initialDrop = null) {
    ...
    const load = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useActiveDrop.useCallback[load]": async ()=>{
            try {
                ...
                if (!response.ok) {
                    const payload = await response.json().catch({
                        "useActiveDrop.useCallback[load]": ()=>({})
                    }["useActiveDrop.useCallback[load]"]);
                ...
                setState({
                    "useActiveDrop.useCallback[load]": (prev)=>({
                            drop: prev.drop,
                            isLoading: false,
                            error: message
                        })
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useActiveDrop.useEffect": ()=>{
            void load();
            const id = setInterval({
                "useActiveDrop.useEffect.id": ()=>{
                    void load();
                }
            }["useActiveDrop.useEffect.id"], POLL_INTERVAL_MS);
            return ({
                "useActiveDrop.useEffect": ()=>clearInterval(id)
            })["useActiveDrop.useEffect"];
        }
    }["useActiveDrop.useEffect"], [
        load
...
_s(useActiveDrop, "+BhfD4jZNK/FU4+5eqNqJXhb68Y=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$hooks$2f$useActiveDrop$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/hooks/useActiveDrop.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$cart$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/cart/CartContext.tsx [app-client] (ecmascript)");
...
function OrderLanding({ initialDrop }) {
    ...
    const { drop } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$hooks$2f$useActiveDrop$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useActiveDrop"])(initialDrop);
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: [
                                            ...
                                            drop.orderCutoffAt && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                children: [
                                                    " — Orders close ",
                                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$format$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDenverDateTime"])(drop.orderCutoffAt)
                                                ]
                                            }, void 0, true)
                                        ]
                                    }, void 0, true, {
...
_s(OrderLanding, "kdW4Vw1T+6JwPxpLcX2PAy6+Y2g=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$cart$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"],
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$hooks$2f$useActiveDrop$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useActiveDrop"]
    ];
});
_c = OrderLanding;
var _c;
...
//# sourceMappingURL=_293c73ff._.js.map